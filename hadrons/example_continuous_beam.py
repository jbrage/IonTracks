...
for idx, data in data_df.iterrows():
    result_df = IonTracks_continuous_beam(E_MeV_u=data.E_MeV_u,
...
# plot
fig, ax = plt.subplots()
sns.lineplot(ax=ax, data=IonTracks_df, x="doserate_Gy_min",
             y="ks_IonTracks", hue="voltage_V", style="particle", markers=True)
ax.set_xscale("log")
