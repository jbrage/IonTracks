...
def total_recombination_PDEsolver(list parameter_list):
    ...
    # load as variables:
    cdef double unit_length_cm  = parameter_list[8] # 5e-4           # cm, size of every voxel length
    cdef double r_cm            = parameter_list[9] # 0.006 # radius of the sampled cylinder
    cdef int buffer_radius      = parameter_list[10] # 10 before
